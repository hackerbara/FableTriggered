...
This directory is the source pipeline for the shipped `packages/hotrod-dragons/`
...
`packages/hotrod-dragons/` byte-for-byte (except any hand-captured
`preview.png`).
