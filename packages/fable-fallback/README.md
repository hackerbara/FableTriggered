...
This is a ClaudeMonkey V1.5 package: it targets `/$bunfs/root/src/entrypoints/cli.js` in Bun module coordinates and is built with the graph-aware repack engine, not legacy byte-slot padding.
