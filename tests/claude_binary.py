...
1. An explicit environment variable override (`CLAUDE_MONKEY_CLAUDE_BIN` for
   the "current/live" `claude` binary, `CLAUDE_MONKEY_CLAUDE_VERSIONS_DIR` for
...
CLAUDE_BIN_ENV = "CLAUDE_MONKEY_CLAUDE_BIN"
CLAUDE_VERSIONS_DIR_ENV = "CLAUDE_MONKEY_CLAUDE_VERSIONS_DIR"
